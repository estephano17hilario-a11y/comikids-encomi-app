...
def main():
    ...
    sftp = ssh.open_sftp()
    sftp_upload_dir(sftp, LOCAL_BACKEND_DIR, "/opt/app/backend")
    sftp.close()
    ...
    cmds = [
        ...
        "curl -i http://127.0.0.1:3000/api/shalom/orders/92644270/label"
    ]
    ...
    print("\n--- [BACKEND LOGS] ---")
    stdin, stdout, stderr = ssh.exec_command("docker logs --tail 30 backend_api")
