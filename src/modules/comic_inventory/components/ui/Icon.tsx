...
const ICONS = {
  ...
  ArrowDown: <g><path d="M12 5v14"/><path d="m19 12-7 7-7-7"/></g>,
  ArrowUp: <g><path d="m5 12 7-7 7 7"/><path d="M12 19V5"/></g>,
  Box: <g><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22v-9"/></g>,
  User: <g><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></g>,
  Tag: <g><path d="M12 2H2v10l9.29 9.29c.94.94 2.48.94 3.42 0l6.58-6.58c.94-.94.94-2.48 0-3.42L12 2Z"/><path d="M7 7h.01"/></g>,
  ...
  History: <g><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M12 7v5l4 2"/></g>,
  ...
  Footprints: <g><path d="M4 16v-2.38C4 11.5 2.97 10.5 3 8c.03-2.72 1.49-6 4.5-6C9.37 2 11 3.8 11 8c0 1.25-.51 2.05-1.5 2.75"/><path d="M20 20v-2.38c0-2.12 1.03-3.12 1-5.62-.03-2.72-1.49-6-4.5-6C14.63 6 13 7.8 13 12c0 1.25.51 2.05 1.5 2.75"/><path d="M16 17h-8"/><path d="M13 13v7"/><path d="M11 13v7"/></g>,
  ...
  Loader: <g><path d="M12 2v4"/><path d="m16.2 7.8 2.9-2.9"/><path d="M18 12h4"/><path d="m16.2 16.2 2.9 2.9"/><path d="M12 18v4"/><path d="m4.9 19.1 2.9-2.9"/><path d="M2 12h4"/><path d="m4.9 4.9 2.9 2.9"/></g>
};
...
export const Icon: React.FC<IconProps> = ({ name, size = 20, className = '', ...props }) => (
  <svg
    ...
    {...props}
  >
    {ICONS[name as IconName] || ICONS.Box}
  </svg>
);
