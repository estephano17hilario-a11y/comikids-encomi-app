    ...
    <div className="space-y-4 animate-fadeIn text-left">
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-3">
        <GlassPanel className="p-3.5 bg-slate-900/80 border-white/8" noHover>
          ...
          <p className="text-base sm:text-xl font-mono font-black text-cyan-300 mt-1">S/ {totalRevenue.toLocaleString()}</p>
        </GlassPanel>

        <GlassPanel className="p-3.5 bg-slate-900/80 border-white/8" noHover>
          <p className="text-[10px] uppercase tracking-wider text-slate-400 font-bold">Ganancia Neta</p>
          <p className="text-base sm:text-xl font-mono font-black text-emerald-400 mt-1">S/ {totalProfit.toLocaleString()}</p>
        </GlassPanel>
      ...
      <div className="space-y-2">
        <h3 className="text-xs uppercase tracking-wider text-slate-400 font-bold px-1">Historial de Transacciones</h3>
