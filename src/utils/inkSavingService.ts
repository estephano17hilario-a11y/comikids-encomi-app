  ...
  switch (level) {
    case 90:
      return {
        ...
        dniText: 'text-2xl sm:text-3xl font-mono font-black tracking-widest text-black',
    ...
    case 75:
      return {
        ...
        dniText: 'text-2xl sm:text-3xl font-mono font-black tracking-widest text-slate-950',
    ...
    case 25:
      return {
        ...
        dniText: 'text-2xl sm:text-3xl font-mono font-black tracking-widest text-white',
